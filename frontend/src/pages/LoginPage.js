...
/** 
 * Adds interaction logic to the login form.
*
* - Captures user data upon submission.
* - Redirects to the dashboard after successful login.
* - Allows navigation to the registry and password recovery.
*
* @returns {void}
 */
...
/**
 * Add interaction logic to the password recovery form.
 *
 * - Displays a spinner while simulating the request to the backend.
 * - Notifies the user with a message upon completion of the action.
 ...
 * @param {HTMLElement} toastEl - The toast element where the message will be shown.
 * @returns {void}
 */
