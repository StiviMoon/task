        ...
        <form id="registerForm" novalidate>
          ...
          <div class="input-group">
            <div class="password-input-wrapper">
              ...
              <button type="button" class="password-toggle" id="confirmPasswordToggle" aria-label="Mostrar confirmación de contraseña">
                <svg viewBox="0 0 24 24">
                  <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                  <circle cx="12" cy="12" r="3"></circle>
                </svg>
...
export function addRegisterLogic() {
 ...
 // Helper function to show errors
  ...
  const togglePasswordVisibility = (toggle, input, labelShow, labelHide) => {
    toggle.addEventListener("click", () => {
      ...
      if (isPassword) {
        ...
        `;
        toggle.setAttribute("aria-label", labelHide);
      } else {
        // Show "show" icon
        svg.innerHTML = `
          <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
          <circle cx="12" cy="12" r="3"></circle>
        `;
        toggle.setAttribute("aria-label", labelShow);
      }
    });
  };

  // Apply toggle to both password fields
  togglePasswordVisibility(passwordToggle, passwordInput, "Mostrar contraseña", "Ocultar contraseña");
  togglePasswordVisibility(confirmPasswordToggle, confirmPasswordInput, "Mostrar confirmación de contraseña", "Ocultar confirmación de contraseña");
